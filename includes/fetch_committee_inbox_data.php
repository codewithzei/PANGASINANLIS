...
// =========================================================================
// 1. FUNCTION PARA SA COMMITTEE INBOX DATA TABLE
// =========================================================================
function getCommitteeInbox() {
    global $pdo;
    
    try {
        // Base sa database dump mo, ang routing_option_id ng "Committee" ay 3
        ...
        $stmt->execute([':routing_id' => $committeeRoutingId]);
...
// =========================================================================
// 2. FUNCTION PARA SA VIEW MODAL NG COMMITTEE INBOX (Full Details)
// =========================================================================
function getCommitteeInboxDocumentById($docId) {
    global $pdo;
            ...
            LEFT JOIN document_routes dr
                ...
                AND dr.route_id = (
                    ...
                    WHERE document_id = d.document_id
                      AND action_taken = 'ROUTED' -- Pinalitan ng ROUTED kasi galing na ito sa ibang division
                )
...
// =========================================================================
if (isset($_GET['action']) && $_GET['action'] === 'getCommitteeInboxDocument' && isset($_GET['id'])) {
    header('Content-Type: application/json');

    $docId = filter_input(INPUT_GET, 'id', FILTER_VALIDATE_INT);
    $doc = getCommitteeInboxDocumentById($docId);
