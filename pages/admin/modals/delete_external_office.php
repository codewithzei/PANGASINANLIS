...
<div id="external-office-delete-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="deleteModalOverlay" 
        onclick="closeModal('external-office-delete-modal')"
    ...
    <div 
        ...
        <div class="flex items-center justify-between p-5 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Delete External Office</h2>
            <button 
                id="deleteCloseBtn"
                onclick="closeModal('external-office-delete-modal')"
        ...
        <div class="p-6">
            ...
            <h3 class="text-lg font-medium text-gray-900 text-center mb-2">
                Delete External Office?
            </h3>
            <p class="text-sm text-gray-600 text-center mb-6">
                Are you sure you want to delete the external office <span id="deleteExternalOfficeName" class="font-semibold text-gray-800"></span>? This action will mark the external office as deleted.
            </p>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-200">
            ...
            <form id="deleteExternalOfficeForm" method="POST" action="../../includes/actions_admin/delete_external_office.php" class="inline">
                <input type="hidden" id="deleteExternalOfficeId" name="external_office_id">
                <button 
                    type="submit"
                    id="confirmDeleteBtn"
...
function deleteExternalOffice(externalOfficeId, externalOfficeName) {
    document.getElementById('deleteExternalOfficeId').value = externalOfficeId;
    document.getElementById('deleteExternalOfficeName').textContent = externalOfficeName;
    openModal('external-office-delete-modal');
}
</script>
