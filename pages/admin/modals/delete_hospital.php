...
<div id="hospital-delete-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="deleteModalOverlay" 
        onclick="closeModal('hospital-delete-modal')"
    ...
    <div 
        ...
        <div class="flex items-center justify-between p-5 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Delete Hospital</h2>
            <button 
                id="deleteCloseBtn"
                onclick="closeModal('hospital-delete-modal')"
        ...
        <div class="p-6">
            ...
            <p class="text-sm text-gray-600 text-center mb-6">
                Are you sure you want to delete the hospital <span id="deleteHospitalName" class="font-semibold text-gray-800"></span>? This action will mark the hospital as deleted.
            </p>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-200">
            ...
            <form id="deleteHospitalForm" method="POST" action="../../includes/actions_admin/delete_hospital.php" class="inline">
                <input type="hidden" id="deleteHospitalId" name="hospital_id">
                <button 
                    type="submit"
                    id="confirmDeleteBtn"
...
function deleteHospital(hospitalId, hospitalName) {
    ...
    openModal('hospital-delete-modal');
}
</script>
