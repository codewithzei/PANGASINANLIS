...
<div id="routing-option-delete-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="deleteModalOverlay" 
        onclick="closeModal('routing-option-delete-modal')"
    ...
    <div 
        ...
        <div class="flex items-center justify-between p-5 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Delete Routing Option</h2>
            <button 
                id="deleteCloseBtn"
                onclick="closeModal('routing-option-delete-modal')"
        ...
        <div class="p-6">
            ...
            <p class="text-sm text-gray-600 text-center mb-6">
                Are you sure you want to delete the routing option <span id="deleteRoutingOptionName" class="font-semibold text-gray-800"></span>? This action will mark the routing option as deleted.
            </p>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-200">
            ...
            <form id="deleteRoutingOptionForm" method="POST" action="../../includes/actions_admin/delete_routing_option.php" class="inline">
                <input type="hidden" id="deleteRoutingOptionId" name="routing_option_id">
                <button 
                    type="submit"
                    id="confirmDeleteBtn"
...
function deleteRoutingOption(routingOptionId, routingOptionName) {
    document.getElementById('deleteRoutingOptionId').value = routingOptionId;
    document.getElementById('deleteRoutingOptionName').textContent = routingOptionName;
    openModal('routing-option-delete-modal');
}
</script>
