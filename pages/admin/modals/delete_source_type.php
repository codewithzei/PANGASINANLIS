...
<div id="source-type-delete-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="deleteModalOverlay" 
        onclick="closeModal('source-type-delete-modal')"
    ...
    <div 
        ...
        <div class="flex items-center justify-between p-5 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Delete Source Type</h2>
            <button 
                id="deleteCloseBtn"
                onclick="closeModal('source-type-delete-modal')"
        ...
        <div class="p-6">
            ...
            <p class="text-sm text-gray-600 text-center mb-6">
                Are you sure you want to delete the source type <span id="deleteSourceTypeName" class="font-semibold text-gray-800"></span>? This action will mark the source type as deleted.
            </p>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-200">
            ...
            <form id="deleteSourceTypeForm" method="POST" action="../../includes/actions_admin/delete_source_type.php" class="inline">
                <input type="hidden" id="deleteSourceTypeId" name="source_type_id">
                <button 
                    type="submit"
                    id="confirmDeleteBtn"
...
function deleteSourceType(sourceTypeId, sourceTypeName) {
    document.getElementById('deleteSourceTypeId').value = sourceTypeId;
    document.getElementById('deleteSourceTypeName').textContent = sourceTypeName;
    openModal('source-type-delete-modal');
}
</script>
