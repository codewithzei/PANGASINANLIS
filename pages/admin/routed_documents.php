...
include '../../includes/fetch_routed_documents_data.php'; // Include the fetch file
require_once '../../includes/badges.php';
require_once '../../classes/document.php';
$docObj = new Document($pdo);
$nextTrackingNumber = $docObj->generateTrackingNumber();

// Fetch Data para sa bawat Tab
$ongoingDocs = getAllRoutedDocuments('ongoing');
$completedDocs = getAllRoutedDocuments('completed');
$withdrawnDocs = getAllRoutedDocuments('withdrawn');
    ...
    <div class="flex-1 md:ml-64 min-h-screen">
        ...
        <main class="p-3 sm:p-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-slate-200 mb-2">
                <div class="p-4 border-b border-slate-200">
                    <div class="flex space-x-1">
                        <button class="tab-button active px-4 py-2 text-sm font-medium text-blue-600 border-b-2 border-blue-600" data-tab="tab-ongoing" onclick="switchTab(this)">
                            On Going
                        </button>
                        <button class="tab-button px-4 py-2 text-sm font-medium text-slate-600 hover:text-slate-800 border-b-2 border-transparent" data-tab="tab-completed" onclick="switchTab(this)">
                            Completed
                        </button>
                        <button class="tab-button px-4 py-2 text-sm font-medium text-slate-600 hover:text-slate-800 border-b-2 border-transparent" data-tab="tab-withdrawn" onclick="switchTab(this)">
                            Withdrawn
                        </button>
                    </div>
                </div>
            ...
            <!-- =====================================
                 TAB 1: ON GOING
            ====================================== -->
            <div id="tab-ongoing" class="tab-panel bg-white rounded-lg shadow-sm border border-slate-200">
                <div class="p-6 border-b border-slate-200">
                    <div class="flex flex-col gap-4">
                        <div>
                            <h2 class="text-xl font-bold text-gray-800">On Going Documents</h2>
                            <p class="text-sm text-gray-600 mt-1">Track and manage documents currently in process</p>
                        </div>
                        <div class="flex items-center gap-3 w-full">
                            <div class="relative flex-1">
                                ...
                                <input type="text" id="searchInput-ongoing" placeholder="Search..."
                                    ...
                                    oninput="filterTabTable('tableBody-ongoing', this.value)">
                            </div>
                            <button onclick="openModal('route-file-modal')"
                                ...
                                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 17 5-5-5-5"/><path d="M4 18v-2a4 4 0 0 1 4-4h12"/></svg>
                                Route File
                            </button>
                        </div>
                    </div>
                ...
                <div class="w-full overflow-x-auto">
                    <!-- BINALIK NATIN SA min-w-full para mag-fit ng kusa sa desktop! -->
                    <table id="table-ongoing" class="min-w-full divide-y divide-slate-200">
                        <thead class="bg-slate-50">
                            <tr>
                                <!-- Naka-whitespace-nowrap ang headers para hindi maputol sa mobile -->
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(0, 'table-ongoing')">
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(1, 'table-ongoing')">
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(2, 'table-ongoing')">
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(3, 'table-ongoing')">
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(4, 'table-ongoing')">
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap">Action</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-slate-200" id="tableBody-ongoing">
                            ...
                            <?php elseif (!empty($ongoingDocs)): ?>
                                <?php foreach ($ongoingDocs as $doc): ?>
                                    <tr class="hover:bg-slate-50 transition-colors duration-150">
                                        <!-- Tracking No: Naka-whitespace-nowrap para hindi masira -->
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-[#0033A1]">
                                            <?php echo htmlspecialchars($doc['tracking_number']); ?>
                                        </td>
                                        
                                        <!-- Subject Matter: HINDI naka-nowrap para mag-break sa desktop, pero may min-w-64 (256px) para hindi lumiit ng sobra sa mobile na mag-cacause ng scroll -->
                                        <td class="px-6 py-4 text-sm text-gray-700 break-words min-w-64">
                                            <?php echo htmlspecialchars($doc['subject_matter']); ?>
                                        </td>
                                        
                                        <!-- The Rest: Naka-whitespace-nowrap para hindi magsikip at mapilitang mag-overflow sa mobile -->
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center gap-2">
                                                <button onclick="viewDocument(<?php echo $doc['document_id']; ?>)" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 rounded transition duration-150 cursor-pointer">
                ...
                <div class="px-4 sm:px-6 py-4 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div id="paginationInfo-ongoing" class="text-sm text-gray-700">Showing <span class="font-medium">0</span> to <span class="font-medium">0</span> of <span class="font-medium">0</span> results</div>
                    <div id="paginationContainer-ongoing" class="flex items-center space-x-2"></div>
                </div>
            </div>
            ...
            <div id="tab-completed" class="tab-panel bg-white rounded-lg shadow-sm border border-slate-200" style="display:none;">
                ...
                <div class="w-full overflow-x-auto">
                    <!-- Tinanggal ang table-fixed at w-full. Ginamit ang min-w-full para fit sa desktop, scroll sa mobile -->
                    <table id="table-completed" class="min-w-full divide-y divide-slate-200">
                        <thead class="bg-slate-50">
                            <tr>
                                <!-- Tinanggal yung w-[15%], px-3 sm:px-6, at pinalitan ng px-6 na may whitespace-nowrap -->
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(0, 'table-completed')">
                                    <div class="flex items-center gap-2">Tracking No.
                                        <svg class="h-4 w-4 text-gray-400 sort-icon" data-column="0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                                    </div>
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(1, 'table-completed')">
                                    <div class="flex items-center gap-2">Subject Matter
                                        <svg class="h-4 w-4 text-gray-400 sort-icon" data-column="1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                                    </div>
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(2, 'table-completed')">
                                    <div class="flex items-center gap-2">Document Type
                                        <svg class="h-4 w-4 text-gray-400 sort-icon" data-column="2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                                    </div>
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(3, 'table-completed')">
                                    <div class="flex items-center gap-2">Division
                                        <svg class="h-4 w-4 text-gray-400 sort-icon" data-column="3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                                    </div>
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(4, 'table-completed')">
                                    <div class="flex items-center gap-2">Status
                                        <svg class="h-4 w-4 text-gray-400 sort-icon" data-column="4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                                    </div>
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-slate-200" id="tableBody-completed">
                            ...
                            <?php elseif (!empty($completedDocs)): ?>
                                <?php foreach ($completedDocs as $doc): ?>
                                    <tr class="hover:bg-slate-50 transition-colors duration-150">
                                        <!-- LAHAT ay naging px-6 py-4 na para pantay sa Header -->
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-[#0033A1]">
                                            <?php echo htmlspecialchars($doc['tracking_number']); ?>
                                        </td>
                                        
                                        <!-- Ang Subject Matter ay pwedeng mag-wrap (break-words) pero hindi pwedeng sobrang liit (min-w-[250px]) -->
            ...
            <div id="tab-withdrawn" class="tab-panel bg-white rounded-lg shadow-sm border border-slate-200" style="display:none;">
                ...
                <div class="w-full overflow-x-auto">
                    ...
                    <table id="table-withdrawn" class="min-w-full divide-y divide-slate-200">
                        <thead class="bg-slate-50">
                            <tr>
                                <!-- Pinalitan ng px-6 py-3 at nilagyan ng whitespace-nowrap para hindi masira sa mobile -->
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(0, 'table-withdrawn')">
                                    <div class="flex items-center gap-2">Tracking No.
                                        <svg class="h-4 w-4 text-gray-400 sort-icon" data-column="0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                                    </div>
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(1, 'table-withdrawn')">
                                    <div class="flex items-center gap-2">Subject Matter
                                        <svg class="h-4 w-4 text-gray-400 sort-icon" data-column="1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                                    </div>
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(2, 'table-withdrawn')">
                                    <div class="flex items-center gap-2">Document Type
                                        <svg class="h-4 w-4 text-gray-400 sort-icon" data-column="2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                                    </div>
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(3, 'table-withdrawn')">
                                    <div class="flex items-center gap-2">Division
                                        <svg class="h-4 w-4 text-gray-400 sort-icon" data-column="3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                                    </div>
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider whitespace-nowrap cursor-pointer" onclick="sortTable(4, 'table-withdrawn')">
                                    <div class="flex items-center gap-2">Status
                                        <svg class="h-4 w-4 text-gray-400 sort-icon" data-column="4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                                    </div>
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-slate-200" id="tableBody-withdrawn">
                            ...
                            <?php elseif (!empty($withdrawnDocs)): ?>
                                <?php foreach ($withdrawnDocs as $doc): ?>
                                    <tr class="hover:bg-slate-50 transition-colors duration-150">
                                        <!-- LAHAT ay ginawang px-6 py-4 para laging pantay sa Header -->
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-[#0033A1]">
                                            <?php echo htmlspecialchars($doc['tracking_number']); ?>
                                        </td>
                                        
                                        <!-- Pwedeng mag-break ang Subject Matter para hindi humaba sa desktop, pero may min width na 250px para mag-scroll sa mobile -->
                                        <td class="px-6 py-4 text-sm text-gray-700 break-words min-w-[250px]">
                                            <?php echo htmlspecialchars($doc['subject_matter']); ?>
                                        </td>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const tabs = [
            { tableBodyId: 'tableBody-ongoing',   paginationContainerId: 'paginationContainer-ongoing',   infoDisplayId: 'paginationInfo-ongoing' },
            ...
            if (tbody) {
                ...
                if (rows.length === 0 && typeof toggleEmptyState === 'function') {
                    toggleEmptyState(cfg.tableBodyId, true, {
                        ...
                        subtitle: "Routed documents will appear here"
                    });
                }
            }
        });
