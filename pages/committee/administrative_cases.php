...
<div class="">
    ...
    <div class="flex-1 md:ml-64 min-h-screen">
        ...
        <?php
        $pageTitle = 'Administrative Cases';
            ...
            <div class="bg-white rounded-lg shadow-sm border border-slate-200 mb-2">
                <div class="p-4 border-b border-slate-200">
                    <div class="flex space-x-1">
                        <button class="tab-button active px-4 py-2 text-sm font-medium text-blue-600 border-b-2 border-blue-600" data-tab="tab-active-cases" onclick="switchTab(this)">
                            Active Cases
                        </button>
                        <button class="tab-button px-4 py-2 text-sm font-medium text-slate-600 hover:text-slate-800 border-b-2 border-transparent" data-tab="tab-committee-reports" onclick="switchTab(this)">
                            Committee Reports
                        </button>
                    </div>
                </div>
