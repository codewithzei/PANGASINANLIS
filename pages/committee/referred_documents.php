            ...
            <div class="bg-white rounded-lg shadow-sm border border-slate-200 mb-2">
                <div class="p-4 border-b border-slate-200">
                    <div class="flex space-x-1">
                        <button class="tab-button active px-4 py-2 text-sm font-medium text-blue-600 border-b-2 border-blue-600" data-tab="tab-referred" onclick="switchTab(this)">
                            Referred
                        </button>
                        <button class="tab-button px-4 py-2 text-sm font-medium text-slate-600 hover:text-slate-800 border-b-2 border-transparent" data-tab="tab-for-opinion" onclick="switchTab(this)">
                            For Opinion
                        </button>
                        <button class="tab-button px-4 py-2 text-sm font-medium text-slate-600 hover:text-slate-800 border-b-2 border-transparent" data-tab="tab-ready-for-agenda" onclick="switchTab(this)">
                            Ready for Agenda
                        </button>
                    </div>
                </div>
