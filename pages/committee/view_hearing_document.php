...
<div class="">
    ...
    <div class="flex-1 md:ml-64 min-h-screen">
        <?php
        $pageTitle = 'Hearing: ' . htmlspecialchars($doc['tracking_number']);
        ...
        <main class="p-4 sm:p-6 w-full">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                        <div class="flex items-center justify-between p-5 border-b border-gray-200 bg-slate-50">
                            <h2 class="text-lg font-semibold text-gray-800">Scheduled hearing (agenda)</h2>
                        </div>
                        <div class="p-6">
                ...
                <div class="lg:col-span-1 space-y-6">
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div class="p-6">
                            <?php $currentStatusName = $doc['status_name'] ?? 'Pending'; ?>
                            
                            <!-- MAGANDANG DESIGN PARA SA VIEWING -->
                            <div class="bg-slate-50 rounded-xl border border-slate-100 p-5 flex flex-col items-center justify-center shadow-sm">
                                <span class="text-base font-regular text-slate-500 ">Hearing Result</span>
                                <span class="text-2xl font-bold text-slate-900"><?php echo htmlspecialchars($currentStatusName); ?></span>
                            </div>
                            
                            <?php if (!in_array($currentStatusName, ['Pending', 'On Going', 'For Calendar'])): ?>
                            <p class="text-sm text-slate-500 mt-5 text-center">
                                Go to the <span class="text-amber-600 font-semibold"><?php echo htmlspecialchars($currentStatusName); ?> Docs</span> tab to create committee reports.
                            </p>
                            <?php endif; ?>
                        </div>
                    </div>
