...
$doc = getForOpinionDocumentById($documentId, $userId);
...
<div class="">
    ...
    <div class="flex-1 md:ml-64 min-h-screen">
        <?php
        $pageTitle = 'For Opinion: ' . htmlspecialchars($doc['tracking_number']);
                ...
                <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <span class="px-3 py-1 inline-flex text-xs font-bold rounded-full border <?php echo getStatusBadgeClass($doc['status_name']); ?> uppercase">
                                        <?php echo htmlspecialchars($doc['status_name'] ?? 'For Opinion'); ?>
                                    </span>
                                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                        <div class="flex items-center justify-between p-5 border-b border-gray-200 bg-slate-50">
                            ...
                            $favorable = count(array_filter($endorsements, fn($e) => ($e['opinion_status_id'] ?? 0) == 2));
                            $total = count($endorsements);
                            $pct = $total > 0 ? round(($favorable / $total) * 100) : 0;
                            ?>
                            <div class="flex items-center gap-3">
                                <span class="text-xs font-bold text-gray-500"><?php echo $favorable; ?>/<?php echo $total; ?> Favorable</span>
                                <div class="w-24 h-2 bg-slate-100 rounded-full overflow-hidden">
                                    <div class="h-full bg-indigo-500 rounded-full" style="width: <?php echo $pct; ?>%"></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody class="bg-white divide-y divide-slate-100">
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($endorsements as $office):
                                            ...
                                            $statusId  = $office['opinion_status_id'] ?? 1;
                                        ...
                                        ?>
                                            <tr class="hover:bg-slate-50 transition-colors duration-150 <?php echo $rowBorderClass; ?>">
                                                ...
                                                <td class="px-6 py-4 text-gray-800 break-words min-w-48 font-medium">
                                                    ...
                                                    <?php if($round > 1): ?>
                                                        <span class="block text-[10px] text-gray-400 font-normal tracking-wide uppercase mt-0.5">Round <?php echo $round; ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                    ...
                                                    <div class="border-slate-200 ml-2">
                                                        <ul class="flex flex-col gap-2">
                                                            ...
                                                            <?php if (!empty($office['opinion_attachment'])): 
                                                                $opPath = '../../uploads/opinions/' . htmlspecialchars($office['opinion_attachment']);
                                                            ...
                                                            <?php if (!empty($office['compliance_attachment'])): 
                                                                $compPath = '../../uploads/compliances/' . htmlspecialchars($office['compliance_attachment']);
...
<?php 
// Modals
include 'modals/endorse_document.php'; 
include 'modals/upload_opinion.php'; 
include 'modals/upload_compliance.php'; 
?>
