...
include '../../includes/fetch_sp_routed_documents_data.php';
...
if (!$documentId) {
    header('Location: routed_documents');
    exit;
}

$doc = getRoutedDocumentById($documentId);
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div class="flex items-center justify-between p-5 border-b border-gray-200 shrink-0 bg-slate-50">
                            <div class="flex items-center gap-3">
                                <a href="routed_documents" class="p-1.5 text-slate-400 hover:text-[#0033A1] hover:bg-blue-50 rounded-lg transition-all" title="Back to Routed Documents">
