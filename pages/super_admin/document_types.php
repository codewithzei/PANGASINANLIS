...
include '../../includes/fetch_doc_types_data.php'; // Include the fetch file
...
<div class="">
    ...
    <div class="flex-1 md:ml-64 min-h-screen">
        ...
        <main class="p-3 sm:p-6">
            ...
            <?php if (isset($_SESSION['document_type_status'])): ?>
                <div id="globalMessage"
                    ...
                    style="<?php echo $_SESSION['document_type_status'] === 'success' ? 'background-color: rgb(220, 252, 231); color: rgb(20, 83, 45); border: 1px solid rgb(167, 243, 208);' : 'background-color: rgb(254, 226, 226); color: rgb(127, 29, 29); border: 1px solid rgb(252, 165, 165);'; ?>">
                    <div class="flex items-center gap-3 px-6 py-4">
                        <?php if ($_SESSION['document_type_status'] === 'success'): ?>
                        ...
                        <?php endif; ?>
                        <span
                            class="text-sm font-medium"><?php echo htmlspecialchars($_SESSION['document_type_message']); ?></span>
                ...
                unset($_SESSION['document_type_status']);
                unset($_SESSION['document_type_message']);
                ?>
            <?php endif; ?>
            ...
            <!-- Header with Title -->
                <div class="p-6 border-b border-slate-200">
                    <div class="flex flex-col gap-4">
                        <div>
                            <h2 class="text-xl font-bold text-gray-800">Document Type</h2>
                            <p class="text-sm text-gray-600 mt-1">Manage and configure document types</p>
                        </div>
                        ...
                        <div class="flex items-center gap-3 w-full">
                            ...
                            <button onclick="openModal('doc-type-add-modal')"
                ...
                <div class="overflow-x-auto">
                    <table id="usersTable" class="min-w-full divide-y divide-slate-200">
                        ...
                        <tbody class="bg-white divide-y divide-slate-200" id="tableBody">
                            <?php if (isset($docTypes['error'])): ?>
                                <tr>
                                    <td colspan="4" class="px-6 py-8 text-center text-red-600">
                                        <?php echo htmlspecialchars($docTypes['error']); ?>
                                    </td>
                                </tr>
...
<?php include 'modals/add_doc_type.php'; ?>
