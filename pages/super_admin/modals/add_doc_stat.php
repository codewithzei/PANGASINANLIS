...
<div id="doc-stat-add-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="modalOverlay" 
        onclick="closeModal('doc-stat-add-modal')"
    ...
    <div 
        ...
        <div class="flex items-center justify-between p-5 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Add Document Status</h2>
            <button 
                id="closeBtn"
                onclick="closeModal('doc-stat-add-modal')"
        ...
        <div id="docStatMessage" class="hidden mx-6 mt-4 p-4 rounded-lg text-sm font-medium">
            <div id="docStatMessageContent"></div>
        </div>

        <!-- Modal Body -->
        <form id="docStatForm" class="p-6" method="POST" action="../../includes/actions_super_admin/add_doc_stat.php">
            <div class="mb-4">
                <label for="docStatInput" class="block text-sm font-medium text-gray-700 mb-2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const modalId = 'doc-stat-add-modal';
    ...
    window.openModal = function(id) {
        if (id === modalId) {
            // Reset the form
            const docStatForm = document.getElementById('docStatForm');
            if (docStatForm) {
                docStatForm.reset();
            }
            
            // Hide message if any
            const docStatMessage = document.getElementById('docStatMessage');
            if (docStatMessage) {
                docStatMessage.classList.add('hidden');
            }
        }
