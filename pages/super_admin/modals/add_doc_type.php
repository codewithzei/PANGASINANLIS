...
<div id="doc-type-add-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="modalOverlay" 
        onclick="closeModal('doc-type-add-modal')"
    ...
    <div 
        ...
        <div class="flex items-center justify-between p-5 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Add Document Type</h2>
            <button 
                id="closeBtn"
                onclick="closeModal('doc-type-add-modal')"
        ...
        <div id="docTypeMessage" class="hidden mx-6 mt-4 p-4 rounded-lg text-sm font-medium">
            <div id="docTypeMessageContent"></div>
        </div>

        <!-- Modal Body -->
        <form id="docTypeForm" class="p-6" method="POST" action="../../includes/actions_super_admin/add_doc_type.php">
            <div class="mb-4">
                <label for="docTypeInput" class="block text-sm font-medium text-gray-700 mb-2">
                    Document Type Name
                </label>
                <input
                    type="text" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const modalId = 'doc-type-add-modal';
    ...
    window.openModal = function(id) {
        if (id === modalId) {
            ...
            // Hide message if any
            const docTypeMessage = document.getElementById('docTypeMessage');
            if (docTypeMessage) {
                docTypeMessage.classList.add('hidden');
            }
        }
