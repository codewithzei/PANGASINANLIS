...
<div id="muni-city-add-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="modalOverlay" 
        onclick="closeModal('muni-city-add-modal')"
    ...
    <div 
        ...
        <div class="flex items-center justify-between p-5 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Add Municipality/City</h2>
            <button 
                id="closeBtn"
                onclick="closeModal('muni-city-add-modal')"
        ...
        <div id="muniCityMessage" class="hidden mx-6 mt-4 p-4 rounded-lg text-sm font-medium">
            <div id="muniCityMessageContent"></div>
        </div>

        <!-- Modal Body -->
        <form id="muniCityForm" class="p-6" method="POST" action="../../includes/actions_super_admin/add_muni_city.php">
            <div class="mb-4">
                <label for="muniCityInput" class="block text-sm font-medium text-gray-700 mb-2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const modalId = 'muni-city-add-modal';
    ...
    window.openModal = function(id) {
        if (id === modalId) {
            // Reset the form
            const muniCityForm = document.getElementById('muniCityForm');
            if (muniCityForm) {
                muniCityForm.reset();
            }
            
            // Hide message if any
            const roleMessage = document.getElementById('muniCityMessage');
            if (muniCityMessage) {
                muniCityMessage.classList.add('hidden');
            }
        }
