...
<div id="role-add-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="modalOverlay" 
        onclick="closeModal('role-add-modal')"
    ...
    <div 
        ...
        <div class="flex items-center justify-between p-5 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Add Role</h2>
            <button 
                id="closeBtn"
                onclick="closeModal('role-add-modal')"
        ...
        <div id="roleMessage" class="hidden mx-6 mt-4 p-4 rounded-lg text-sm font-medium">
            <div id="roleMessageContent"></div>
        </div>

        <!-- Modal Body -->
        <form id="roleForm" class="p-6" method="POST" action="../../includes/actions_super_admin/add_role.php">
            <div class="mb-4">
                <label for="roleInput" class="block text-sm font-medium text-gray-700 mb-2">
                    Role Name
                </label>
                <input 
                    type="text" 
