...
<div id="doc-stat-delete-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="deleteModalOverlay" 
        onclick="closeModal('doc-stat-delete-modal')"
    ...
    <div 
        ...
        <div class="flex items-center justify-between p-5 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Delete Document Status</h2>
            <button 
                id="deleteCloseBtn"
                onclick="closeModal('doc-stat-delete-modal')"
        ...
        <div class="p-6">
            ...
            <p class="text-sm text-gray-600 text-center mb-6">
                Are you sure you want to delete the document status <span id="deleteDocStatName" class="font-semibold text-gray-800"></span>? This action will mark the document status as deleted.
            </p>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-200">
            ...
            <form id="deleteDocStatForm" method="POST" action="../../includes/actions_super_admin/delete_doc_stat.php" class="inline">
                <input type="hidden" id="deleteDocStatId" name="document_status_id">
                <button 
                    type="submit"
                    id="confirmDeleteBtn"
...
function deleteDocStat(docStatId, docStatName) {
    document.getElementById('deleteDocStatId').value = docStatId;
    document.getElementById('deleteDocStatName').textContent = docStatName;
    openModal('doc-stat-delete-modal');
}
</script>
