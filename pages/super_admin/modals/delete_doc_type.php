...
<div id="doc-type-delete-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="deleteModalOverlay" 
        onclick="closeModal('doc-type-delete-modal')"
    ...
    <div 
        ...
        <div class="p-6">
            ...
            <p class="text-sm text-gray-600 text-center mb-6">
                Are you sure you want to delete the document type <span id="deleteDocTypeName" class="font-semibold text-gray-800"></span>? This action will mark the document type as deleted.
            </p>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-200">
            ...
            <form id="deleteDocTypeForm" method="POST" action="../../includes/actions_super_admin/delete_doc_type.php" class="inline">
                <input type="hidden" id="deleteDocTypeId" name="document_type_id">
                <button 
                    type="submit"
                    id="confirmDeleteBtn"
...
function deleteDocType(docTypeId, docTypeName) {
    document.getElementById('deleteDocTypeId').value = docTypeId;
    document.getElementById('deleteDocTypeName').textContent = docTypeName;
    openModal('doc-type-delete-modal');
}
</script>
