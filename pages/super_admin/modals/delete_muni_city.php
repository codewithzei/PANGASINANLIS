...
<div id="muni-city-delete-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="deleteModalOverlay" 
        onclick="closeModal('muni-city-delete-modal')"
    ...
    <div 
        ...
        <div class="flex items-center justify-between p-5 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Delete Municipality/City</h2>
            <button 
                id="deleteCloseBtn"
                onclick="closeModal('muni-city-delete-modal')"
        ...
        <div class="p-6">
            ...
            <p class="text-sm text-gray-600 text-center mb-6">
                Are you sure you want to delete the municipality/city <span id="deleteMuniCityName" class="font-semibold text-gray-800"></span>? This action will mark the municipality/city as deleted.
            </p>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-200">
            ...
            <form id="deleteMuniCityForm" method="POST" action="../../includes/actions_super_admin/delete_muni_city.php" class="inline">
                <input type="hidden" id="deleteMuniCityId" name="muni_city_id">
                <button 
                    type="submit"
                    id="confirmDeleteBtn"
...
function deleteMuniCity(muniCityId, muniCityName) {
    document.getElementById('deleteMuniCityId').value = muniCityId;
    document.getElementById('deleteMuniCityName').textContent = muniCityName;
    openModal('muni-city-delete-modal');
}
</script>
