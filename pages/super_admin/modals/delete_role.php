...
<div id="role-delete-modal" class="hidden">
    
    <!-- Modal Overlay -->
    <div 
        id="deleteModalOverlay" 
        onclick="closeModal('role-delete-modal')"
    ...
    <div 
        ...
        <div class="p-6">
            ...
            <p class="text-sm text-gray-600 text-center mb-6">
                Are you sure you want to delete the role <span id="deleteRoleName" class="font-semibold text-gray-800"></span>? This action will mark the role as deleted.
            </p>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-200">
            ...
            <form id="deleteRoleForm" method="POST" action="../../includes/actions_super_admin/delete_role.php" class="inline">
